#include "insertassmode.h".h"
#include <QtGui>
#include "link.h"
#include <QLine>
#include <assoline.h>

insertassmode::insertassmode(diagramscene *pscene)
{
    scene=pscene;
    i=2;
    first=NULL;
...
void insertassmode::mousepress(QGraphicsSceneMouseEvent *event)
{
    first=NULL;
    second=NULL;
    QTransform a;
...
void insertassmode::mouserelease(QGraphicsSceneMouseEvent *event)
{
    QTransform a;
...
*/
    ...
    assoline *line = new assoline(first,second);
