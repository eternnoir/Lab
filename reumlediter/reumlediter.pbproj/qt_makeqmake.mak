...
QMAKE    = /usr/bin/qmake
reumlediter.pbproj/project.pbxproj: reumlediter.pro  /usr/local/Qt4.7/mkspecs/macx-xcode/qmake.conf /usr/local/Qt4.7/mkspecs/common/unix.conf \
	...
	$(QMAKE) -o reumlediter.pbproj/project.pbxproj reumlediter.pro
